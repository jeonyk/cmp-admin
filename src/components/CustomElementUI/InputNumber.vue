...
export default {
  ...
  created () {
    this.thousandsRegEx = this.thousandsSep
      ? new RegExp('(\\d+)(\\' + this.thousandsSep + ')(\\d+)', 'g')
      : null
    this.decimalRegEx = this.decimalSep
      ? new RegExp('\\' + this.decimalSep, 'g')
      : null
  },
  mounted () {
