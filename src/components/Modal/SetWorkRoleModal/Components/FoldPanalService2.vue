    ...
    >
      ...
      <div class="header-left">
        ...
        <span
          v-if="childCount"
          class="count-badge"
        ><span>{{ childCount }}</span></span>
      </div>
      <!-- /.header-left -->

      <div class="header-right">
        <span class="check-title">보기 권한 ({{ readPermCnt }})</span>
        <span class="check-title">실행 권한 ({{ executePermCnt }})</span>
        <slot name="header-suffix" />
        <span class="expand-icon">
          <span
            id="btnCollapse"
            class="tree-is-child-icon "
