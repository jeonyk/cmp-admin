<template>
  <div class="modal-firewalleq-edit">
    <section class="register-top-form">
      ...
      >
        ...
        >
          <el-option
            v-for="option in firewallTypeOptions"
            :key="option.codeName"
            :label="option.label"
...
export default {
  ...
  async created () {
    ...
    this.firewallTypeOptions = await this.getCodeList('FIREWALL_CLASS')
  },
  methods: {
    ...
    */
    ...
    validatedOTP (data) {
      ...
      this.newFormData.switchForm.isManualManagement = data.isManualManagement
