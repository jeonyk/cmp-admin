  ...
  <div class="task-compute task-resource-grid">
    ...
    >
      <div class="process-top-area">
        <span class="sub-title">Network L4</span>
...
import TaskSourceModalL4 from '@/components/Modal/TaskSourceModal/TaskSourceModalL4'
...
export default {
  ...
  components: {
    ...
    'task-source-modal-l4': TaskSourceModalL4,
  ...
  created () {
    this.columns = this.setColumns_V3(this.rawColumns, 'NETWORK_L4')
  ...
  methods: {
    ...
    setInitData (tableData) {
      ...
      const list = cloneData.map(row => {
        ...
        const { vrserverName } = row.configJson ?? {}
