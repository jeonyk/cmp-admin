  ...
  <div class="task-compute task-resource-grid">
    ...
    >
      <div class="process-top-area">
        <span class="sub-title">Network L7</span>
...
import TaskSourceModalL7 from '@/components/Modal/TaskSourceModal/TaskSourceModalL7'
...
export default {
  ...
  components: {
    ...
    'task-source-modal-l7': TaskSourceModalL7,
  ...
  created () {
    this.columns = this.setColumns_V3(this.rawColumns, 'NETWORK_L7')
  ...
  methods: {
    ...
    setInitData (tableData) {
      ...
      const list = cloneData.map(row => {
        ...
        const { csVrserverName } = row.configJson ?? {}
