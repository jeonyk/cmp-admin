  ...
  <div class="task-compute task-resource-grid">
    ...
    >
      <div class="process-top-area">
        <span class="sub-title">VMware</span>
...
import TaskSourceModalVMware from '@/components/Modal/TaskSourceModal/TaskSourceModalVMware'
...
export default {
  ...
  components: {
    ...
    'task-source-modal-vmware': TaskSourceModalVMware,
  ...
  created () {
    this.columns = this.setColumns_V3(this.rawColumns, 'VM')
