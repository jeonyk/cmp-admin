...
export default {
  ...
  methods: {
    ...
    checkHandler () {
      ...
      const temp = uniqBy([...this.gridData, ...originCheckedData], 'userDbIdx')
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { binding: 'hostname', header: '호스트 명', keyPath: 'common.GRID.hostName', customHtml: true },
