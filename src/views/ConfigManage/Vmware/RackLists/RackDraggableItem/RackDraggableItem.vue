...
<template>
  <div
    ...
    :class="{'-active': active, '-notCluster': type === 'block' && cluster.clusterName === undefined}"
...
export default {
  ...
  created () {
    ...
    console.log('rackMode: ', this.rackMode)
  },
  watch: {
    data (newVal) {
  ...
  methods: {
    ...
    onDragEnd (e, rack, cluster) {
      ...
      // const clusteritem = rack.clusters.fillter(item => item.blocks.length > 0)
