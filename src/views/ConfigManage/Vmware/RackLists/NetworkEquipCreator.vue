...
<template>
  <div class="network-equip-creator">
    <section class="modal-body">
      <!-- <register-contents
        :title="$t('common.MODAL.elementInfo')"
        required
      >
        <el-select
          ...
          v-model="listInfo.ctg"
          @change="changeCtg"
          :disabled="data !== null"
        >
          <el-option
            v-for="item in ctgOptions"
            :key="item.ipCategoryIdx"
            :label="item.codeValue"
            :value="item.ipCategoryIdx"
          />
        </el-select>
        <el-select
        ...
        <el-select
          :placeholder="$t('common.REGCON.selectElement')"
          :popper-append-to-body="false"
          class="datacenter-selector"
          v-model="listInfo.element"
          :disabled="data !== null"
        >
          <el-option
...
export default {
  ...
  created () {
    console.log('@@created ', this.data, this.ctgDatas, this.clusters)
    this.setCtgOptions()
  },
  watch: {
    data: {
